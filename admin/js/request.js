...
function add_device(){
	var device_type = document.getElementsByName("type")[0].value;
	...
	var params = "?w=device&o=insert&aktiv=" + device_aktiv + "&device_name=" + device_name + "&room=" + room_id + "&letter=" + letter + "&code=" + c1 + c2 + c3 + c4 + c5 + "&sort=" + device_sort + "&type=" + device_type;
	if(device_name!=""){
...
function update_device_send(id){
	...
	var params = "?wid=" + id + "&w=device&o=update&aktiv=" + device_aktiv + "&device_name=" + device_name + "&room=" + room_id + "&letter=" + letter + "&code=" + c1 + c2 + c3 + c4 + c5 + "&sort=" + device_sort + "&type=" + device_type;
	if(device_name!=""){
		request('request.php', 'GET', params, function(){ window.location.reload(); } );
	}
}
