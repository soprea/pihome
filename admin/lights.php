  ...
  ?>	
    ...
    <div class="light">
      <div class="name">
       ...
       <div class="room"><?=utf8_encode(getRoomById($lp[$i]["room_id"]));?></div>
      </div>
      <div class="letter"><?=$lp[$i]["letter"];?></div>
      <div class="code"><?=$lp[$i]["code"];?></div>
      <div class="btn">
        <span><a href="javascript:aktiv_device('<?=$lp[$i]["id"];?>');"><img src="images/<?=$deimg;?>" border="0"></a></span>
        <span><a href="javascript:update_device('<?=$lp[$i]["id"];?>');"><img src="images/work.png" border="0"></a></span>
        <span><a href="javascript:del_device('<?=$lp[$i]["id"];?>');"><img id="btn2_<?=$lp[$i]["id"];?>" src="images/del.png" border="0"></a></span>
      </div>
  </div>
  </li>
  <?
