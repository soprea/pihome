...
<div id="nav">
	...
	<span><a href="index.php?p=logout"><img src="images/logout.png" border="0"></a></span>
</div>
...
<div id="tabcontainer">
	...
	<div id="devices" class="tabcontent">
		...
		<form id="formdevice" method="post">
			<select name="aktiv"><option value="1">enable</option><option value="0">disable</option></select>
			<br><br>
			Device Name:<br>
			<input type="text" name="device_name"><br><br>
			Sort:<br>
			<input type="text" name="sort" size="10" value="0"><br><br>				
