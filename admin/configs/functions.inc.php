...
function pihome_acp_login($pih_username,$pih_passwort) {
    ...
    if (!$zeileholen) { die ("<meta http-equiv='refresh' content='0; URL=index.php'></SCRIPT><script language='JavaScript'>(window-alert('Username not found'))</script>"); }
    if ($zeileholen["pass"] <> $pih_passwort)
    { die ("<meta http-equiv='refresh' content='0; URL=index.php'></SCRIPT><script language='JavaScript'>(window-alert('Incorrect password provided!!'))</script>");
    } else {
