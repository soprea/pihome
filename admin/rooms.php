	...
	?>	
		<li>
			<div class="light">			
				...
				<div class="btn_room">
					<span><a href="javascript:update_room('<?=$rp[$x]["id"];?>');"><img src="images/work.png" border="0"></a></span>
					<span><a href="javascript:del_room('<?=$rp[$x]["id"];?>');"><img src="images/del.png" border="0"></a></span>
				</div>
			</div>
		</li>
	<?
